    ...
    return(
        ...
        max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden">
            ...
            <div className="text-white">
                <h2 className="text-3xl font font-medium">Do You Own a Luxury Car?</h2>
                <p className="mt-2">Monetize your vehicle effortlessly by listing it on CarRental.</p>
                <p className="max-w-130">We take care insurance, driver verification and secure payments - so you can earn passive income, stree-free.</p>
