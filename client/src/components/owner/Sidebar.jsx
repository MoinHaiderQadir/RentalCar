...
const Sidebar = ()=>{
    ...
    return(
        <div className="relative min-h-screnn md:flex flex-col items-center pt-8
        max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm">

            <div className="group relative">
                <label htmlFor="image">
                    <img src={image ? URL.createObjectURL(image) : user?.image || 
                        "https://www.google.com/url?sa=i&url=https%3A%2F%2Funsplash.com%2Fs%2Fphotos%2Fsplash&psig=AOvVaw1usuSSPirEn6s_IL5Zlgdy&ust=1754673986805000&source=images&cd=vfe&opi=89978449&ved=0CBUQjRxqFwoTCLjqwpac-Y4DFQAAAAAdAAAAABAE"  } alt="" 
